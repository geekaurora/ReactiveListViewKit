...
open class CZFeedListFacadeView: UIView {
  ...
  public func batchUpdate(withFeeds feeds: [Any],
                          animated: Bool = true) {
...
private extension CZFeedListFacadeView  {
  ...
  func reloadListView(animated: Bool) {
    ...
    // Update current `viewModel` with `newViewModel` after diffing calculation,
    // to ensure consistent state before/after collectionView batchUpdate.
...
extension CZFeedListFacadeView: UICollectionViewDelegateFlowLayout {
  ...
  public func collectionView(_ collectionView: UICollectionView,
    ...
    // For CZHorizontalSectionAdapterCell, should set its height with `viewModel.viewHeight`.
    ...
    // Support self-sizing cells for the vertical orientation.
