...
public class CZListDiff: NSObject {
  ...
  private static func diffSectionModels(
    current: [CZSectionModel],
    prev: [CZSectionModel]) ->
  (sections: [SectionDiffResultKey: [CZSectionModel]], rows: [RowDiffResultKey: [CZFeedModel]]) {
    ...
    let rowsDiff: [RowDiffResultKey: [CZFeedModel]] = self.diffFeedModels(
      current: currFeedModels,
      prev: prevFeedModels)
  ...
  public static func diffFeedModels<FeedModelType: CZFeedModelable>(
    current currFeedModels: [FeedModelType],
  ...
  public typealias SectionIndexDiffResult = (sections: [SectionDiffResultKey: Any], 
                                             rows: [RowDiffResultKey: [Any]])
  ...
  public static func diffSectionModelIndexes(current: [CZSectionModel], 
                                             prev: [CZSectionModel]) -> SectionIndexDiffResult {
